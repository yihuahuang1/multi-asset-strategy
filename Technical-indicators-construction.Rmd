...
### \textcolor{blue}{Technical Indicator 1: Simple Moving Avaerage (SMA)}  
...
### \textcolor{blue}{Technical Indicator 2: Exponential Moving Average (EMA)}  
...
### \textcolor{blue}{Technical Indicator 3: Moving Average Convergence Divergence (MACD)}    



### \textcolor{blue}{Technical Indicator 4: Relative Strength Index (RSI)}  
...
### \textcolor{blue}{Technical Indicator 5: Bollinger Band (BB)} 


### \textcolor{blue}{Technical Indicator 6: 2-day Momentum (2-day Mom)}  

### \textcolor{blue}{Technical Indicator 7: Price Volume Trend (PVT)} 
...
stocklist <- c("AAPL","GOOG","MSFT","NVDA","WMT","XOM")
getSymbols(stocklist)
AAPL <- last(AAPL,'3 years')
head(AAPL)
# https://www.r-bloggers.com/2016/10/quantitative-stock-analysis-tutorial-screening-the-returns-for-every-sampp500-stock-in-less-than-5-minutes/amp/
```
